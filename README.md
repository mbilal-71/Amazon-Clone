...
- **Search Filtering**: Live search suggestions and filtering of product categories.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/mbilal71-hub/Amazon-Clone.git
   ```
...
- `script.js`: Interactive features (cart, search, scroll).
